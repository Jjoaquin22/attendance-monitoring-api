# attendance-monitoring-api

Backend API for the Attendance Monitoring system (FastAPI + face recognition pipeline).

## Run locally
- Create a virtual environment
- Install dependencies (see `requirements.txt` inside this repo)
- Start the server:
  - `python api/server.py`

## Notes
- This repository contains the backend code extracted from the main Attendance Monitoring workspace.
